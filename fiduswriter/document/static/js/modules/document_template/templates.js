...
<label>
    <input type="checkbox" class="elements" value="uploadFile" ${elements.includes('uploadFile') ? 'checked' : ''}/>
...
const fileUploadTemplate = ({
    id="",
    title="",
    elements=["uploadFile", "manageFile", "paragraph", "heading1", "heading2", "heading3", "heading4", "heading5", "heading6", "figure", "ordered_list", "bullet_list", "horizontal_rule", "equation", "citation", "blockquote", "footnote"],
    marks=["strong", "em", "underline", "link"],
    locking="false",
    optional="false",
    language=false,
